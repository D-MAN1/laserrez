    ...
    @endforeach
        ...
        <table class="table  table-striped">
            ...
            <tr class='alert-info'>
                ...
                <th scope="col" class="text-center">Стоимость кв.м, руб.</th>
                <th scope="col" class="text-center">Скорость реза мм/мин</th>
                <th scope="col" class="text-center">Стоимость метра реза</th>
            </tr>
            </thead>
            <tbody>
            @php 
            ...
            <tr class='alert-dark'>
                ...
                <td></td>
                <td></td>
                <td class="h3">{{(array_keys($materials)[$i])}}</td>
                <td></td>
                <td></td>
                <td></td>
            </tr>
            ...
            <tr id='mat0-0'>
                <td>
                   <input class="text-center btn btn-sm border border-warning btn-close " type="submit" name="{{$material->id}}:delete" onClick="this.form.submit()" value="" id="{{$material->id}}_ch">
                </td>
                <td class="text-center">{{$material->name}}</td>
                <td class="text-center">
                    <input class="w-50" type=number min="1" name="{{$material->id}}:group_material" value='{{$material->group_material}}'>
                </td>
                <td class="text-center">
                    <input class="w-50" type=text name="{{$material->id}}:thickness" value='{{$material->thickness}}'>
                </td>
                <td class="text-center">
                    <input class="w-50" type=text  name="{{$material->id}}:price_material" value='{{$material->price_material}}'>
                </td>
                <td class="text-center">
                    <input class="w-50" type=text  name="{{$material->id}}:speed" class='mmmin' value='{{$material->speed}}'>
                </td>
        
                <td class="text-center">
                    <input class="w-50" type=text  name="{{$material->id}}:price_rez" class='mprice' value='{{$material->price_rez}}'>
                </td>
            </tr>
        ...
        <hr>
        <br>
        <div class="alert-info"><h4>Добавить</h4></div>
        <form method="POST" action="{{ route('admin.update') }}">
            {{ csrf_field() }}
            ...
            <tr id='mat0-0'>
                ...
                <td>
                    <input type=number min="1" name="group_material" value=''>
                </td>
                <td>
                    <input type=text name="thickness" value=''>
                </td>
                <td>
                    <input type=text  name="price_material" value=''>
                </td>
                <td>
                ...
                <td>
                    <input type=text  name="price_rez" value=''>
                </td>
            </tr>
            <tbody>
            </table>
