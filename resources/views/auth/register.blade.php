                ...
                <div class="card-body text-black-50 font-monospace">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label fw-bold">Имя</label>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label fw-bold">E-Mail адрес</label>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label  fw-bold">Повторите пароль</label>
